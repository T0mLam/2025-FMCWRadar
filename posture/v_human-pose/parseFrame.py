...
def parseStandardFrame(frameData, DEBUG):
    ...
    for i in range(numTLVs):
        ...
        # micro doppler outputs
            ...
            outputDict['classifier_info'] = frameData[:tlvLength]
            outputDict['surfaceType'], outputDict['classificationResult'] = parseClassTLV(frameData[:tlvLength], tlvLength)
            print(outputDict['surfaceType'], ": ", outputDict['classificationResult'])
