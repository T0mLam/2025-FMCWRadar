...
2. - In device manager find UART prt number
    <img src="images/Device_manager.jpg" alt="Device manager COM port" width="520"/>
  - Enter the COM port number in CLI port feld
3. Choose x432 Out of Box Demo in demo field
<img src="images/Industrial_Visualiser_1.jpg" alt="Industrial Visualiser setup" width="520"/>
...
<img src="images/Industrial_Visualiser_2.jpg" alt="Chrip config load" width="520"/>
...
<img src="images/Industrial_Visualiser_3.jpg" alt="Data record button" width="520"/>
