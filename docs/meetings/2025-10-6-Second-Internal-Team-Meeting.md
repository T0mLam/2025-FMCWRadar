...
1. The Ethics form.  
2. Correct contract type.  
3. Each team member to go through documentation and research how the project will work.  
4. Summarize findings and add research notes to Docusaurus.  
5. Set up machines with the required software from Texas Instruments' website.  
