...
This document describes the usage of AI tools within the FMCW Radar project, what limits we place on them, and how we ensure we are complaint with university standards.

## AI Tools
- **ChatGPT** and **Google Gemeni** are both used as conversational assistants to help with debugging code, note clean ups to catch typos and grammar issues, and introductory research on new topics or new languages.
- **Editor Autocomplete:** (e.g. VS Code suggestions) used to speed up typing not to generate significant program logic.
