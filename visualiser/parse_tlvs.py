...
mlClassTypes = (0, "ML_TYPE_WET_DRY", "ML_TYPE_GRASS_NOTGRASS", "ML_TYPE_HUMANPOSE")
liquidClass = ("DRY", "WET")
grassClass = ("GRASS", "NOTGRASS")
poseClass = ("STOOD", "SAT", "LYING", "SITTING", "FALLING", "NONE")
...
def parseClassTLV(tlvData, tlvLength):
    ...
    print(mlClassResults)

    mlMax = mlResult.argmax()
    if mlResult[mlMax] < 0.5:
        mlMax = 3

    return mlClassTypes[mlClassType], poseClass[mlMax], mlResult
