...
# 01	MMWDEMO_OUTPUT_EXT_MSG_DETECTED_POINTS	20 Bytes + (10 Bytes x Num Detected Obj)	Compressed version of the point cloud in Cartesian coordinates
...
MMWDEMO_OUTPUT_MSG_ML_CLASSIFICATION                    = 1031
