...
parserFunctions = {
    ...
    MMWDEMO_OUTPUT_EXT_MSG_MICRO_DOPPLER_RAW_DATA:          parseMicroDopplerRawDataTLV,
    MMWDEMO_OUTPUT_EXT_MSG_MICRO_DOPPLER_FEATURES:          parseMicroDopplerFeaturesTLV,
...
def parseStandardFrame(frameData, demo=None):
    ...
    outputDict['tlvsSeen'] = [] #NICETOHAVE sanity check for which TLVs were in the frame
    ...
    for i in range(numTLVs):
        try:
            ...
            outputDict['tlvsSeen'].append(int(tlvType)) #NICETOHAVE
